<?php
define("TOKEN", "penis");                                       // The secret token to add as a GitHub or GitLab secret, or otherwise as https://www.example.com/?token=secret-token
define("REMOTE_REPOSITORY", "git@github.com:mikem1/trainingapp.git"); // The SSH URL to your repository
